...
public abstract class CustomComboBox<T> extends ComboBox<CustomComboBox.CustomComboItem<T>> {
    ...
    public static <E, I extends CustomComboItem<E>> void setSelectedValue(@NotNull JComboBox<I> comboBox, @Nullable E value) {
        I item;
    ...
    protected static class CustomComboItem<E> {
        ...
        public boolean equals(final Object obj) {
            ...
            if (!(obj instanceof CustomComboBox.CustomComboItem)) {
                return false;
            }
